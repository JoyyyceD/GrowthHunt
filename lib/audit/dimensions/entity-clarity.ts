...
export const entityClarity: Dimension = {
  ...
  run(ctx: AuditContext) {
    ...
    checks.push(mkCheck('title-present', 'Title tag present and well-sized', 8,
    ...
    checks.push(mkCheck('meta-desc-present', 'Meta description present', 8,
    ...
    checks.push(mkCheck('name-in-title', 'Brand name in title', 8,
    ...
    checks.push(mkCheck('name-in-h1', 'Brand name in H1', 12,
    ...
    checks.push(mkCheck('name-in-meta-desc', 'Brand name in meta description', 8,
    ...
    checks.push(mkCheck('name-in-first-para', 'Brand name in opening copy', 10,
    ...
    checks.push(mkCheck('about-contact', 'About / Contact links', 6,
