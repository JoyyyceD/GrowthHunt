...
export const FEATURES: Feature[] = [
  ...
  {
    id: 'x-templates', name: 'ViralX — Templates → Your X', tag: 'Live', module: 'distribution',
    pitch: '10,000+ viral tweet templates from 500+ AI founders. Steal, customize, schedule, ship.',
    hook: 'Steal what worked. Schedule it. Ship to your own X.',
    summary: 'A live template lab pulled from 500+ AI founder + startup accounts. Pick a viral pattern that fits your startup, customize it in one click, schedule the post, and ship it to your own X account — without leaving the page.',
    problem: 'Staring at the X compose box is the worst part of marketing. Most founders ship 3 tweets a month and wonder why nothing happens.',
    solution: 'Filter to the templates that match your startup, customize the structure, schedule and post directly to your own X — all in one place. Browse free; sign in to schedule and post.',
    example: { input: 'AI IDE for game devs', output: '→ matched AI coding · top template: Cursor Series C framing · scheduled for Tue 9:12am' },
    launchUrl: '/viralx',
  },
  {
    id: 'startup-lib', name: 'ViralX — Growth Playbook', tag: 'Live', module: 'distribution',
    pitch: 'The 5 viral archetypes behind the AI startups breaking out on X.',
    hook: 'How they did it. In their words.',
    summary: 'A magazine-style report on what makes AI startup tweets go viral. 5 archetypes, 3 stages of growth, founder vs official playbooks, 12-month roadmap. Built from 10,000+ tweets across 500+ AI founder + startup accounts.',
    problem: 'You\'re reinventing GTM. Cursor, Lovable, DeepSeek, Hedra already figured most of it out.',
    solution: 'Read the playbook. Each archetype is anchored in a real viral tweet from the dataset. Cross-links straight into the lab so you can grab the template, edit it, and ship.',
    example: { input: 'Read No. 01', output: '5 archetypes · 8 deep dives · 6 cross-cutting laws · 12-month roadmap' },
    launchUrl: '/viralx/playbook',
  },
