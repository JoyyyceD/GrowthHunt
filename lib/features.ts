...
export const FEATURES: Feature[] = [
  ...
  {
    id: 'x-templates', name: 'Xhunter — X Viral Templates', tag: 'Live', module: 'distribution',
    pitch: '3,447 viral tweets from 277 AI startups. Filter to find your match.',
    hook: 'Steal the structure. Add your story.',
    summary: 'A live library of viral X tweets from AI founders and official accounts — filterable by category, account type, and content tag (viral / launch / metric / thread / low-key demo / engagement / meme / behind-the-scenes).',
    problem: 'Staring at the X compose box is the worst part of marketing.',
    solution: 'Find the templates closest to your startup, then steal what is working. Free to browse with login.',
    example: { input: 'AI IDE for game devs', output: '→ matched AI coding · 312 tweets · top: Cursor Series C ($900M, 12.7K likes)' },
    launchUrl: '/xhunter',
  },
  {
    id: 'startup-lib', name: 'Xhunter — Growth Playbook', tag: 'Live', module: 'distribution',
    pitch: 'A pattern study of 326 viral tweets — the 5 archetypes that win.',
    hook: 'How they did it. In their words.',
    summary: 'A magazine-style report on what makes AI startup tweets go viral. 5 archetypes, 3 stages of growth, founder vs official playbooks, 12-month roadmap. Built from 3,447 tweets.',
    problem: 'You\'re reinventing GTM. Cursor, Lovable, DeepSeek, Hedra already figured most of it out.',
    solution: 'Read the playbook. Each archetype is anchored in a real viral tweet from the dataset. Cross-links to the live lab.',
    example: { input: 'Read No. 01', output: '5 archetypes · 8 deep dives · 6 cross-cutting laws · 12-month roadmap' },
    launchUrl: '/xhunter/playbook',
  },
