...
export const metadata: Metadata = {
  title: 'PicoLaunch — AI startups, one issue a week',
  description:
    'A weekly launch board for AI startups doing real GTM. Twelve picks every Monday. Upvote, comment, follow.',
  alternates: { canonical: 'https://growthhunt.ai/picolaunch' },
  openGraph: {
    type: 'website',
    url: 'https://growthhunt.ai/picolaunch',
    title: 'PicoLaunch — A weekly launch board for AI startups',
    description: 'Twelve AI-startup picks every Monday. Upvote, comment, follow.',
  },
}
...
export default async function PicoLaunchHome() {
  ...
  const jsonLd = {
    ...
    '@type': 'ItemList',
    name: 'PicoLaunch — AI startup launch board',
  ...
  return (
    <div>
      ...
      <header className="opc-header">
        <div className="shell">
          <div className="eyebrow"><span className="dot" />Curated weekly · For AI startups</div>
          <h1>AI <em>startups,</em><br />one issue a week.</h1>
          <p className="opc-sub">
            <b>PicoLaunch</b> is GrowthHunt&rsquo;s launch board for AI startups doing real GTM —
            small teams shipping product, finding their first users, telling their story. Twelve picks
            each Monday. Upvote, comment, follow.
          </p>
        </div>
      </header>
      ...
      {champions.length === 0 && (
        <section className="opc-section">
          <div className="shell">
            <p className="opc-sub">Nothing live yet — check back Monday.</p>
          </div>
        </section>
      )}
      ...
      <section className="opc-section" style={{ padding: '72px 0', borderTop: '1px solid var(--rule)', marginTop: 56 }}>
        <div className="shell">
          <div className="eyebrow"><span className="dot" />For AI founders</div>
