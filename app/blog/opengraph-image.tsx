  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ fontSize: 20, lineHeight: 1.5, color: 'rgba(20,17,13,0.55)', fontFamily: 'Georgia, serif', maxWidth: 760, fontStyle: 'italic', marginTop: 8 }}>
          Practical guides on creator outreach, Reddit research, cold email, and go-to-market execution.
        </div>
      </div>
