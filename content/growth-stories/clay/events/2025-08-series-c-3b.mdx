...
The mechanism is the cleanest narrative-upgrade move in our case set. By coining a category — GTM Engineer — Clay positions itself as infrastructure for that category rather than a tool the role uses. The Series C reads as funding the category formation, not funding the company.
