...
For context across our case set, that pace is not unprecedented but it is fast. Cursor's Series A to Series B was 6.5x in four months (the highest in our set). Clay's 2.5x in six months sits in the band that signals "investor demand exceeds primary capacity" — high enough to mark a clear narrative class change, low enough to avoid the "this looks frothy" framing in capital press.
