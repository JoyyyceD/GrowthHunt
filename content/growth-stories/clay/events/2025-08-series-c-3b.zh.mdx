...
<Catalyst>
C 轮没有被定位成一笔融资。BusinessWire 的标题是「AI GTM Leader Clay Raises $100M Series C to Fuel GTM Engineering Roles Industrywide」。品类框架是新闻。融资是证据点。这是我们 案例库里最干净的叙事升级执行——开创一个品类，并在同一份公告里资助这个品类。
</Catalyst>
