...
description: "An anonymous Quebec C++ programmer wrote a node-based UI for Stable Diffusion on January 1, 2023, kept his identity hidden for 37 months while the project compounded into a 115K-star OSS substrate, declined to be CEO when Comfy Org was finally formed in June 2024, and still attracted a $30M Craft Ventures-led round at $500M post-money in April 2026. The first case in the set to deliberately vacate the founder-as-IP position and still reach unicorn-track scale."
date: "2026-06-01"
readTime: "12 min"
---
