...
Most "tech-narrative-upgrade" plays in our case set move from app to platform to infrastructure on the back of new product capabilities ready at announcement. Cursor's D1 (Composer + own model launched simultaneously with the platform-tier narrative). Manus's D1 (the multi-agent architecture demo and the platform claim ship together).
