...
In our case set, the case studies that ship "format-as-credibility-constraint" launches usually do it as a 90-second X video (Manus) or a comparative head-to-head demo (Cursor vs Copilot). Linear's variant is even tighter: the format is **the actual app, with no narration, loading in real time**.
