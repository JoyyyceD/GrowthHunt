...
The logic is the same one Cursor used at a different cadence: a solo "$X funding" announcement gets you 3-5 days of capital-press coverage. A "$X funding + $Y ARR + new product" bundle gets you the same window across capital press, dev press, telco trade press, and SaaS press — for the same announcement budget.
...
The strategic-investor list on the Series C tells the same story: Deutsche Telekom, NTT DOCOMO Ventures, RingCentral Ventures, HubSpot Ventures, Salesforce Ventures. Telco and CRM, not creator tools. The pivot up the stack was the precondition for those checks.
