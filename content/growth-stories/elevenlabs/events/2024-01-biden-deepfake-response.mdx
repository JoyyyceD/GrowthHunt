...
**3. AI Speech Classifier reference.** The free public tool from January 2023 was re-surfaced as the technical answer to "how do we know if audio is from ElevenLabs?" — Pindrop had used a similar method.
...
| Resemble | Mayor Adams incident (Apr) | ElevenLabs was named — Resemble was not |
...
By the time Deutsche Telekom, NTT DOCOMO Ventures, RingCentral Ventures, Salesforce Ventures, and HubSpot Ventures came in on the Series C in January 2025, voice-AI vendor due diligence routinely included questions about misuse handling. ElevenLabs could point to a 12-month operational track record:

- 4chan incident (Jan 2023) → paid-only cloning + classifier
- Biden robocall (Jan 2024) → 72-hour ban + FCC engagement
- Mayor Adams incident (Apr 2024) → account review + policy clarification
