...
description: "a16z and ICONIQ co-led, but the headline was the new strategic-investor list: Deutsche Telekom, NTT DOCOMO, RingCentral, HubSpot, LG Technology Ventures (Salesforce was a returning investor). The Series C wasn't capital — it was distribution embedded in a cap table."
date: "2025-01-30"
type: "funding"
...
<Catalyst>
The Series C valuation tripled in 12 months. The lead investors were predictable. The list of new strategics was not. Deutsche Telekom, NTT DOCOMO, RingCentral, HubSpot, and LG Technology Ventures all came in (with Salesforce Ventures returning from earlier rounds) — turning the cap table into a multi-vector enterprise distribution map.
</Catalyst>
