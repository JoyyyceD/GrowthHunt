...
<Catalyst>
The "leak first, bundle on the day, run the milestone as a follow-up" template is the modern AI fundraise playbook. Lovable executed it more compressed than most — eight months from launch, four named-investor namedrops, two news cycles from one announcement. Same budget, more surface.
</Catalyst>
