...
<Catalyst>
Lovable Cloud is a category-claim upgrade — from app builder to full-stack platform — fired in the window between Series A and Series B. This is the release that justifies the Series B valuation, not the Series B itself. The template is familiar across modern AI: when you hit a valuation tier, the next tier requires you to credibly claim a bigger category.
</Catalyst>
