...
**2. Audience boundary.** The marketing copy pivoted from "for developers" framing to "anyone with an idea." This is a different size of TAM by an order of magnitude — the Cursor TAM is ~30M developers; the Lovable TAM is solopreneurs + indie hackers + non-technical builders + small teams + creators.
