...
- **Form factor**: Twelve sizes (up from ten), six colors. **All finishes fully titanium for the first time** — no plastic interior.
- **Workout detection**: 40+ activity types automatically recognized (up from a handful).

Three months later, in January 2025, Samsung Galaxy Ring would ship in the US at $399.
...
| **Samsung Galaxy Ring** | Announced January 2024, shipping Q4 |
