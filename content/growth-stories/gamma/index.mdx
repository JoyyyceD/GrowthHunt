...
By early 2023 the product has roughly 60,000 users. Decent but not breakout. Paul Graham, by Lee's own retelling on Lenny's Podcast, called the idea "the dumbest thing I've heard."
...
The two companies started from similar premises. The deltas were: a deeper pre-AI design substrate at Gamma, slower headcount growth, an explicit refusal to chase the consumer-vs-enterprise debate that paralyzed Tome, and a pricing model — credit-based freemium with $8 / $18 / $100 tiers — that monetized heavy AI usage cleanly.
...
**November 13, 2025** — Lee on Lenny Rachitsky's podcast, the canonical long-form retelling: PG's "dumbest idea" call, the 95% drop-off teardown, the 1,000+ creator program, the small-team thesis.
...
- **Founders who could absorb a 2.5-year flat curve.** Most teams would have pivoted or shut down before March 2023. Lee, Fox, and Noronha had the financial and emotional reserves to keep building through Paul Graham's "dumbest idea" verdict and a 95% drop-off rate.
