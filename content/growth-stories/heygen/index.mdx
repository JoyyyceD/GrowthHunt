...
description: "Two ex-Snap / ex-ByteDance founders spent eighteen months proactively rewriting their company's nationality — relocating from Shenzhen to Los Angeles, dissolving the Shenzhen entity, asking IDG / Baidu / HongShan / ZhenFund to sell their stakes to US counterparts, moving data to Ohio, and making the product unavailable inside China — before any pressure point forced them to. Then they ran the standard AI-creative B + C + D stack at the highest discipline in the case set. Twenty-nine months from $1M to $100M ARR. Profitable the whole way."
date: "2026-06-01"
readTime: "12 min"
---
