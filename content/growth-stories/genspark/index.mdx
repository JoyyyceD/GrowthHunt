...
Genspark is the inverse of Cursor.

Cursor's curve has a 22-month latent period followed by 13 months of vertical takeoff. **Genspark has no latent period.** Day 0 was a $60M pre-revenue seed, a same-day product launch, and a TechCrunch exclusive — engineered around a founder who was already a recognized name in Chinese AI. The growth question isn't "how did the catalyst arrive?" It's "how did the team stay alive long enough to fire it twice?"
...
October 2024, the team shipped an "Autopilot Agent" — async multi-step research, packaged as a smarter Sparkpage. In hindsight that release is the leading indicator. **Six months before the public pivot, the team was already prototyping the agent direction internally.**
...
For comparison: Lovable took two months to $10M, Cursor took six. Genspark did it in nine days — with a 20-person team and zero paid acquisition.

## Hypergrowth — same playbook, repeated

The pattern that ran from April 2025 through April 2026 is mostly Cursor's playbook, executed by a different team in a different category:
...
- **Compounded coverage.** Bloomberg breaks the unicorn news nine days before the Series B announcement. The pre-leak primes the official news. Same template Cursor uses for every TechCrunch funding exclusive.

> "20 people, 45 days, $36M ARR." — the number triple Wen Sang now repeats in every podcast appearance. It's the same operation as Cursor's "fastest SaaS company in history." Make the team-size narrative carry more weight than any single revenue number.

## The three-region capital structure — the part that's hardest to copy

Cursor is a US company with US capital and a US-led customer base. Genspark is a structurally different shape:
...
5. **Bundled milestones, ratcheted up.** Funding + product launch + strategic partnership on the same day. Genspark stacked three on November 20, 2025; Cursor's standard is two. Three stacks compounds.
...
- **A founder with regional pre-existing reputation.** Eric Jing's "father of Xiaoice" plus Xiaodu CEO history is what made the $60M pre-revenue seed coverable as news. Without that, Day 0 doesn't fire.
