...
description: "Cursor stacks two milestones per cycle. On November 20, 2025, Genspark stacked three: $275M Series B, AI Workspace launch, and Microsoft Agent 365 launch-partner status — the densest media day of the entire arc."
date: "2025-11-20"
type: "funding"
...
The Cursor/TechCrunch funding template runs the same way. The template logic:
...
The Cursor playbook bundles two milestones per cycle:

- Series A (Aug 2024) + the "$0 marketing" line
- Series C (Jun 2025) + $500M ARR disclosure
- Series D (Nov 2025) + $1B ARR disclosure
- Cursor 2.0 + Composer model (one product, two narratives)
